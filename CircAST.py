...
def findname1(chr,a):     
	...
	for line in in_table:
		...
		array = line.split()
		if array[3] == a:
			array[11] = array[11][1:-2]
			if array[11] not in gname1:
				gname1.append(array[11])
	in_table.close()
	return gname1 
def findname2(chr,b):  
	gname2 = []
	...
	for line in in_table:
		...
		if array[4] == b:
			array[11] = array[11][1:-2]
			if array[11] not in gname2:
				gname2.append(array[11])
	in_table.close()
	return gname2 
...
def calculate(gene_id,chr_name,match_num_total,head_num,inputfrag_len,tempfile_path):
	...
	for line in in_gtf:
		...
		array = line.split()
		array[11] = array[11][1:-2]
		if array[0] == chr_name and array[2] == "exon" and array[11] == gene_id :
			out_gtf.write(line + "\n")
			row += 1
			if row == 1:
